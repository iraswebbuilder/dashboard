...
# Filter DataFrame berdasarkan start_date dan end_date
day_df = day_df[(day_df['dateday'] >= str(start_date)) &
...
weekday_rent_df = create_weekday_rent_df(day_df)
workingday_rent_df = create_workingday_rent_df(day_df)
holiday_rent_df = create_holiday_rent_df(day_df)
...
colors1=["tab:red", "tab:blue"]
colors2=["tab:red", "tab:blue"]
colors3=["tab:red", "tab:blue", "tab:green", "tab:orange", "tab:purple", "tab:brown", "tab:pink"]
...
st.caption('Copyright (c) ARIS SUTIONO 2023')
